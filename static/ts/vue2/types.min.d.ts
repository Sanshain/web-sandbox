...
declare function computed<T>(options: WritableComputedOptions$1<T>, debugOptions?: DebuggerOptions): WritableComputedRef<T>;
...
declare type ErrorCapturedHook$1<TError = unknown> = (err: TError, instance: any, info: string) => boolean | void;
...
declare function watch<T extends MultiWatchSources, Immediate extends Readonly<boolean> = false>(sources: [...T], cb: WatchCallback<MapSources<T, false>, MapSources<T, Immediate>>, options?: WatchOptions$1<Immediate>): WatchStopHandle;
declare function watch<T extends Readonly<MultiWatchSources>, Immediate extends Readonly<boolean> = false>(source: T, cb: WatchCallback<MapSources<T, false>, MapSources<T, Immediate>>, options?: WatchOptions$1<Immediate>): WatchStopHandle;
declare function watch<T, Immediate extends Readonly<boolean> = false>(source: WatchSource<T>, cb: WatchCallback<T, Immediate extends true ? T | undefined : T>, options?: WatchOptions$1<Immediate>): WatchStopHandle;
declare function watch<T extends object, Immediate extends Readonly<boolean> = false>(source: T, cb: WatchCallback<T, Immediate extends true ? T | undefined : T>, options?: WatchOptions$1<Immediate>): WatchStopHandle;
...
export { AsyncComponent, Component, ComputedOptions$1 as ComponentComputedOptions, ComponentCustomOptions, ComponentCustomProperties, ComponentCustomProps, ComponentInstance, MethodOptions as ComponentMethodOptions, ComponentOptions, ComponentPropsOptions, ComponentPublicInstance, ComputedGetter$1 as ComputedGetter, ComputedOptions, ComputedRef, ComputedSetter$1 as ComputedSetter, CreateComponentPublicInstance, CreateElement, CustomRefFactory, Data, DebuggerEvent, DebuggerEventExtraInfo, DebuggerOptions, DeepReadonly, DefineComponent, Directive, DirectiveBinding$1 as DirectiveBinding, DirectiveFunction, DirectiveHook, DirectiveModifiers, DirectiveOptions, EffectScope, ErrorCapturedHook$1 as ErrorCapturedHook, ExtractDefaultPropTypes, ExtractPropTypes, FunctionDirective, FunctionalComponentOptions, InjectionKey, ObjectDirective, PluginFunction, PluginObject, PropOptions, PropType, ReactiveFlags, Ref, RefUnwrapBailTypes, RenderContext, SetupContext, SetupFunction, ShallowReactive, ShallowRef, ShallowUnwrapRef, ToRef, ToRefs, TrackOpTypes, TriggerOpTypes, UnwrapNestedRefs, UnwrapRef, VNode, VNodeChildren, VNodeChildrenArrayContents, VNodeComponentOptions, VNodeData, VNodeDirective, VueConstructor, WatchCallback, WatchEffect, WatchHandler, WatchOptions, WatchOptionsBase, WatchOptionsWithHandler, WatchSource, WatchStopHandle, WritableComputedOptions$1 as WritableComputedOptions, WritableComputedRef, computed, customRef, Vue as default, defineAsyncComponent, defineComponent, defineEmits, defineExpose, defineProps, del, effectScope, getCurrentInstance, getCurrentScope, h, inject, isProxy, isReactive, isReadonly, isRef, isShallow, markRaw, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onScopeDispose, onServerPrefetch, onUnmounted, onUpdated, provide, proxyRefs, reactive, readonly, ref, set, shallowReactive, shallowReadonly, shallowRef, toRaw, toRef, toRefs, triggerRef, unref, useAttrs, useCssModule, useCssVars, useListeners, useSlots, version, watch, watchEffect, watchPostEffect, watchSyncEffect, withDefaults };
