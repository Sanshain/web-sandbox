...
import { initialize } from "../source/main";
...
test('initial', async () => {
   ...
   const editors = IDE.initialize([], {
      ...
      /**
       * @param {{editor: import("..").AceEditor, mode: string, prevMode?: string}} event
       */
      onModeChange(event) {
         /**
         ...
         Object.assign(
            ...
            },
            {
               typescript: {
                  ...
                  /**
                   *
                   * @param {{disable?: boolean, enable: boolean, editor: import("..").AceEditor, editors: import("../source/aceInitialize").EditorsEnv}} arg
                   */
                  onModeChange({ disable, enable, editor, editors }) {
                     if (enable || (enable === false && disable === false)) {
                        /**
                         * @typedef {Omit<Parameters<import("..").TypescriptEditor['initialize']>[0], 'editor'> & {editor: import("..").AceEditor}} Config
                         * @type {Config}
                         */
                        const config = {
    ...
    *    session?: import("../types/aceInitialize").EditorSession; 
    *    selection?: { 
    *       setRange: (range: Range, selection?: boolean) => unknown; 
    *       getCursor: () => import("../types/aceInitialize").Position; }; 
    *    clearSelection?: () => void; 
    *    moveCursorTo?: (line: number, col: number) => any; 
    *    getValue: any; 
    *    getSession?: () => import("../types/aceInitialize").EditorSession; 
    *    focus?: () => any; 
    ...
    *      fontSize?: string;
    *      tabSize?: number;
    * }, "editor"> & { editor: import("..").AceEditor; }} config
    */
